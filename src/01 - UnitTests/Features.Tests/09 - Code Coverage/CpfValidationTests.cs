...
namespace Features.Tests
{
    public class CpfValidationTests
    {
        ...
        public void Cpf_ValidateMultipleNumbers_AllShouldFail(string cpf)
        {
            // Assert
            var cpfValidation = new CpfValidation();
